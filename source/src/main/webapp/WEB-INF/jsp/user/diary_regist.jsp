			...
			<div class="tenki">
				...
				<div class="date">
					...
					<input type="hidden" name="temperature-max"> -->
						...
						<p>
							最低気温は<span id="mn"></span>
							<input type="hidden" name="tempMin" id="temperature-min"> 
						</p>
						<p>
							最高気温は<span id="mx"></span>
							<input type="hidden" name="tempMax" id="temperature-max">
						</p>
				</div>
			</div>
					...
					<div class="review">
						...
						<div class="stars">
							...
							<span> <input id="1" type="radio" name="satisfaction"
								value="5"><label for="1">★</label> <input id="2"
								type="radio" name="satisfaction" value="4"><label
